...
#ifndef __Agate_msdPIRL_h
#define __Agate_msdPIRL_h
...
/*
*  typedef: enum AGATE_MSD_PIRL_COUNT_MODE
*
...
typedef enum
{
AGATE_MSD_PIRL_COUNT_FRAME = 0,
AGATE_MSD_PIRL_COUNT_ALL_LAYER1,
AGATE_MSD_PIRL_COUNT_ALL_LAYER2,
AGATE_MSD_PIRL_COUNT_ALL_LAYER3
} AGATE_MSD_PIRL_COUNT_MODE;

/*
*  typedef: struct AGATE_MSD_PIRL_CUSTOM_RATE_LIMIT
*
...
*      				    AGATE_MSD_PIRL2_COUNT_FRAME,
*                 		    AGATE_MSD_PIRL2_COUNT_ALL_LAYER1,
*          			    AGATE_MSD_PIRL2_COUNT_ALL_LAYER2, or
*            			    AGATE_MSD_PIRL2_COUNT_ALL_LAYER3
*/
typedef struct
{
MSD_BOOL       isValid;
...
/*Count Mode*/
AGATE_MSD_PIRL_COUNT_MODE       countMode;

} AGATE_MSD_PIRL_CUSTOM_RATE_LIMIT;

/*
*  typedef: enum AGATE_MSD_PIRL_FC_DEASSERT
*
*  Description: Enumeration of the port flow control de-assertion mode on PIRL.
*
*  Enumerations:
*      AGATE_MSD_PIRL_FC_DEASSERT_EMPTY -
*                De-assert when the ingress rate resource has become empty
*        AGATE_MSD_PIRL_FC_DEASSERT_CBS_LIMIT -
*                De-assert when the ingress rate resource has enough room as
*                specified by the CBSLimit.
*/
typedef enum
{
AGATE_MSD_PIRL_FC_DEASSERT_EMPTY = 0,
AGATE_MSD_PIRL_FC_DEASSERT_CBS_LIMIT
} AGATE_MSD_PIRL_FC_DEASSERT;

/*
* Typedef: enum AGATE_MSD_PIRL_ACTION
*
...
*
* Fields:
*        Agate_PIRL_ACTION_ACCEPT - accept the frame
*        Agate_PIRL_ACTION_USE_LIMIT_ACTION - use EBS Limit Action
*/
typedef enum
{
Agate_PIRL_ACTION_USE_LIMIT_ACTION = 0x0,
Agate_PIRL_ACTION_ACCEPT = 0x1
} AGATE_MSD_PIRL_ACTION;


/*
* Typedef: enum AGATE_MSD_EBS_LIMIT_ACTION
*
...
*
* Fields:
*        Agate_EBS_LIMIT_ACTION_DROP - drop packets
*        Agate_EBS_LIMIT_ACTION_FC   - send flow control packet
*/
typedef enum
{
Agate_EBS_LIMIT_ACTION_DROP = 0x0,
Agate_EBS_LIMIT_ACTION_FC = 0x1
} AGATE_MSD_EBS_LIMIT_ACTION;

/*
*  typedef: struct AGATE_MSD_PIRL_DATA
*
...
*                                Agate_PIRL_ACTION_ACCEPT - accept the frame
*                                Agate_PIRL_ACTION_USE_LIMIT_ACTION - use limitAction
...
/*flow control*/
AGATE_MSD_PIRL_FC_DEASSERT		fcMode;
AGATE_MSD_PIRL_ACTION    actionMode;
AGATE_MSD_EBS_LIMIT_ACTION ebsLimitAction;
