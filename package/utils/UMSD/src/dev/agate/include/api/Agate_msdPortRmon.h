...
#ifndef __Agate_msdPortRmon_h
#define __Agate_msdPortRmon_h
...
{
	/* Bank 0 */
    Agate_STATS_InGoodOctetsLo = 0,
    Agate_STATS_InGoodOctetsHi,
    Agate_STATS_InBadOctets,
    
    Agate_STATS_OutFCSErr,
    Agate_STATS_InUnicasts,
    Agate_STATS_Deferred,             /* offset 5 */
    Agate_STATS_InBroadcasts,
    Agate_STATS_InMulticasts,
    Agate_STATS_64Octets,
    Agate_STATS_127Octets,
    Agate_STATS_255Octets,            /* offset 10 */
    Agate_STATS_511Octets,
    Agate_STATS_1023Octets,
    Agate_STATS_MaxOctets,
    Agate_STATS_OutOctetsLo,
    Agate_STATS_OutOctetsHi,
    Agate_STATS_OutUnicasts,          /* offset 16 */
    Agate_STATS_Excessive,
    Agate_STATS_OutMulticasts,
    Agate_STATS_OutBroadcasts,
    Agate_STATS_Single,
    Agate_STATS_OutPause,
    Agate_STATS_InPause,
    Agate_STATS_Multiple,
    Agate_STATS_InUndersize,          /* offset 24 */
    Agate_STATS_InFragments,
    Agate_STATS_InOversize,
    Agate_STATS_InJabber,
    Agate_STATS_InRxErr,
    Agate_STATS_InFCSErr,
    Agate_STATS_Collisions,
    Agate_STATS_Late,                 /* offset 31 */

} AGATE_MSD_STATS_COUNTERS;

/*
 *  typedef: struct AGATE_MSD_STATS_COUNTER_SET
 *
 *  Description: MIB Counter Set
 *     
 */
typedef struct _AGATE_MSD_STATS_COUNTER_SET
{
	/* Bank 0 */
...
}AGATE_MSD_STATS_COUNTER_SET;

typedef struct _AGATE_MSD_STATS_COUNTER_SET_LEGACY
{
	/* Bank 0 */
	MSD_U32    InGoodOctetsLo;     /* offset 0 */
	MSD_U32    InGoodOctetsHi;     /* offset 1 */
...
}AGATE_MSD_STATS_COUNTER_SET_LEGACY;
/*
...
typedef enum
{
	AGATE_MSD_COUNT_RX_ONLY = 1,
	AGATE_MSD_COUNT_TX_ONLY,
	AGATE_MSD_COUNT_RX_TX
} AGATE_MSD_HISTOGRAM_MODE;
