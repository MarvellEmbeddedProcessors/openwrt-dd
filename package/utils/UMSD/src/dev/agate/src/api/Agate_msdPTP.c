...
)
{
	...
	MSD_DBG_INFO(("Agate_gptpSetIntEnable Called.\n"));
	...
	MSD_DBG_INFO(("Agate_gptpSetIntEnable Exit.\n"));
	return retval;
}
...
)
{
	...
	MSD_DBG_INFO(("Agate_gptpGetIntEnable Called.\n"));
	...
	MSD_DBG_INFO(("Agate_gptpGetIntEnable Exit.\n"));
	return retval;
}
...
)
{
	...
	MSD_DBG_INFO(("Agate_gptpSetProtPTPEn Called.\n"));
	...
	MSD_DBG_INFO(("Agate_gptpSetProtPTPEn Exit.\n"));
	return retval;
}
...
)
{
	...
	MSD_DBG_INFO(("Agate_gptpGetProtPTPEn Called.\n"));
	...
	*en = (data & 0x1) ? MSD_FALSE : MSD_TRUE;
	...
	MSD_DBG_INFO(("Agate_gptpGetProtPTPEn Exit.\n"));
	return retval;
}
...
)
{
	MSD_STATUS retVal;
	MSD_U32 data = 0;
	MSD_DBG_INFO(("Agate_gptpSetPortConfig Called.\n"));
	...
	MSD_DBG_INFO(("Agate_gptpSetPortConfig Exit.\n"));
	return retVal;
}
...
)
{
	MSD_STATUS retVal;
	MSD_U32 data = 0;
	MSD_DBG_INFO(("Agate_gptpGetPortConfig Called.\n"));
	...
	MSD_DBG_INFO(("Agate_gptpGetPortConfig Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_DBG_INFO(("Agate_gptpGetTimeStamp Called.\n"));
	...
	switch (timeToRead)
	{
	case AGATE_PTP_ARR0_TIME:
		opData.ptpAddr = baseReg + 0;
		break;
	case AGATE_PTP_ARR1_TIME:
		opData.ptpAddr = baseReg + 4;
		break;
	case AGATE_PTP_DEP_TIME:
	...
	ptpStatus->timeStamped = AGATEMSD_PTP_BUILD_TIME(opData.ptpMultiData[2], opData.ptpMultiData[1]);
	ptpStatus->ptpSeqId = opData.ptpMultiData[3];

	MSD_DBG_INFO(("Agate_gptpGetTimeStamp Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_U32 data = 0;
	MSD_U32 baseReg;
	MSD_DBG_INFO(("Agate_gptpGetTSValidSt Called.\n"));
	...
	*isValid = (data & 0x1) ? MSD_TRUE : MSD_FALSE;
	MSD_DBG_INFO(("Agate_gptpGetTSValidSt Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_U32 baseReg;
	int index;
	MSD_DBG_INFO(("Agate_gptpResetTimeStamp Called.\n"));
	...
	MSD_DBG_INFO(("Agate_gptpResetTimeStamp Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_PTP_OPERATION op;
	MSD_PTP_OP_DATA opData;
	MSD_DBG_INFO(("Agate_gptpGetGlobalConfig Called.\n"));
	...
	MSD_DBG_INFO(("Agate_gptpGetGlobalConfig Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_PTP_OPERATION op;
	MSD_PTP_OP_DATA opData;
	MSD_DBG_INFO(("Agate_gptpGetIntStatus Called.\n"));
	...
	MSD_DBG_INFO(("Agate_gptpGetIntStatus Exit.\n"));
	return retVal;
}