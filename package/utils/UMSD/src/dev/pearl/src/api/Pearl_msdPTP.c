...
)
{
	...
	MSD_DBG_INFO(("Pearl_gptpSetIntEnable Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_gptpSetIntEnable Exit.\n"));
	return retval;
}
...
)
{
	...
	MSD_DBG_INFO(("Pearl_gptpGetIntEnable Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_gptpGetIntEnable Exit.\n"));
	return retval;
}
...
)
{
	...
	MSD_DBG_INFO(("Pearl_gptpSetProtPTPEn Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_gptpSetProtPTPEn Exit.\n"));
	return retval;
}
...
)
{
	...
	MSD_DBG_INFO(("Pearl_gptpGetProtPTPEn Called.\n"));
	...
	*en = (data & 0x1) ? MSD_FALSE : MSD_TRUE;
	...
	MSD_DBG_INFO(("Pearl_gptpGetProtPTPEn Exit.\n"));
	return retval;
}
...
)
{
	MSD_STATUS retVal;
	MSD_U32 data = 0;
	MSD_DBG_INFO(("Pearl_gptpSetPortConfig Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_gptpSetPortConfig Exit.\n"));
	return retVal;
}
...
)
{
	MSD_STATUS retVal;
	MSD_U32 data = 0;
	MSD_DBG_INFO(("Pearl_gptpGetPortConfig Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_gptpGetPortConfig Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_DBG_INFO(("Pearl_gptpGetTimeStamp Called.\n"));
	...
	switch (timeToRead)
	{
	case PEARL_PTP_ARR0_TIME:
		opData.ptpAddr = baseReg + 0;
		break;
	case PEARL_PTP_ARR1_TIME:
		opData.ptpAddr = baseReg + 4;
		break;
	case PEARL_PTP_DEP_TIME:
	...
	ptpStatus->timeStamped = PEARLMSD_PTP_BUILD_TIME(opData.ptpMultiData[2], opData.ptpMultiData[1]);
	ptpStatus->ptpSeqId = opData.ptpMultiData[3];

	MSD_DBG_INFO(("Pearl_gptpGetTimeStamp Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_U32 data = 0;
	MSD_U32 baseReg;
	MSD_DBG_INFO(("Pearl_gptpGetTSValidSt Called.\n"));
	...
	*isValid = (data & 0x1) ? MSD_TRUE : MSD_FALSE;
	MSD_DBG_INFO(("Pearl_gptpGetTSValidSt Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_U32 baseReg;
	int index;
	MSD_DBG_INFO(("Pearl_gptpResetTimeStamp Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_gptpResetTimeStamp Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_PTP_OPERATION op;
	MSD_PTP_OP_DATA opData;
	MSD_DBG_INFO(("Pearl_gptpGetGlobalConfig Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_gptpGetGlobalConfig Exit.\n"));
	return retVal;
}
...
)
{
	...
	MSD_PTP_OPERATION op;
	MSD_PTP_OP_DATA opData;
	MSD_DBG_INFO(("Pearl_gptpGetIntStatus Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_gptpGetIntStatus Exit.\n"));
	return retVal;
}