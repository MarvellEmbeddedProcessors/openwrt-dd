...
)
{
	...
	MSD_DBG_INFO(("Pearl_msdRmuGetID Called.\n"));
	...
	*id = ((*(rspEthPacketPtr + 24 - delta) & 0xff) << 8) | (*(rspEthPacketPtr + 25 - delta) & 0xff);
	...
	MSD_DBG_INFO(("Pearl_msdRmuGetID Exit.\n"));
	return MSD_OK;
}
...
)
{
	...
	MSD_DBG_INFO(("Pearl_msdRmuAtuDump Called.\n"));
	...
	*startAddr = next_cont_code;
	...
	MSD_DBG_INFO(("Pearl_msdRmuAtuDump Exit.\n"));
...
)
{
	...
	MSD_DBG_INFO(("Pearl_msdRmuMib2Dump Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_rmuMib2Dump Exit.\n"));
...
)
{
	...
	MSD_DBG_INFO(("Pearl_msdRmuReadRegister Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_msdRmuReadRegister Exit.\n"));
...
)
{
	...
	MSD_DBG_INFO(("Pearl_msdRmuWriteRegister Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_msdRmuWriteRegister Exit.\n"));
...
)
{
	...
	MSD_DBG_INFO(("Pearl_msdRmuMultiRegAccess Called.\n"));
	...
	MSD_DBG_INFO(("Pearl_msdRmuMultiRegAccess Exit.\n"));
...
)
{
    ...
    MSD_DBG_INFO(("Pearl_msdRmuRegDump Called.\n"));
    ...
    if ((retVal = Pearl_msdRmuMultiRegAccess(dev, &pRegCmd, nCmd)) != MSD_OK)
    {
        MSD_DBG_ERROR(("Pearl_msdRmuMultiRegAccess returned fail.\n"));
        return retVal;
    }
    ...
    MSD_DBG_INFO(("Pearl_msdRmuRegDump Exit.\n"));
    return MSD_OK;
}
