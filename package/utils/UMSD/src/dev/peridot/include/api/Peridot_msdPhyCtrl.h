...
#ifndef __Peridot_msdPhyCtrl_h
#define __Peridot_msdPhyCtrl_h
...
*         it is recommended to call Peridot_gprtSetPortAutoMode for PHY configuration after 
*         Loopback test.
...
MSD_STATUS Peridot_gphySetPortSpeedIntf
(
IN MSD_QD_DEV *dev,
IN MSD_LPORT  port,
...
MSD_STATUS Peridot_gphySetPortAutoModeIntf
(
IN MSD_QD_DEV *dev,
IN MSD_LPORT  port,
