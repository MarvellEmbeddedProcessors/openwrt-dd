...
#ifndef __Topaz_msdBrgVtu_h
#define __Topaz_msdBrgVtu_h
...
/****************************************************************************/
/*
 *  typedef: struct TOPAZ_MSD_VTU_EXT_INFO
 *
 *  Description: 
 ...
 */
 typedef enum
 {
	 Topaz_MEMBER_EGRESS_UNMODIFIED=0,
	 Topaz_MEMBER_EGRESS_UNTAGGED,
	 Topaz_MEMBER_EGRESS_TAGGED,
	 Topaz_NOT_A_MEMBER
 }TOPAZ_MSD_MEMTAGP;

/*
 *  typedef: struct TOPAZ_MSD_VTU_ENTRY
 *
...
typedef struct
{
    ...
    MSD_U16        vid;
    MSD_U8         sid;
    TOPAZ_MSD_MEMTAGP    memberTagP[MSD_MAX_SWITCH_PORTS];
    MSD_BOOL          vidPolicy;
    TOPAZ_MSD_VTU_EXT_INFO    vidExInfo;
} TOPAZ_MSD_VTU_ENTRY;

/*
 *  typedef: struct TOPAZ_MSD_VTU_INT_STATUS
 *
...
typedef struct
{
    ...
    MSD_U8    spid;
    MSD_U16   vid;
} TOPAZ_MSD_VTU_INT_STATUS;

/*
 * Bit Vector Definition for VTU Violation
 */
#define TOPAZ_MSD_VTU_MEMBER_VIOLATION            	0x4
#define TOPAZ_MSD_VTU_MISS_VIOLATION              	0x2
#define TOPAZ_MSD_VTU_FULL_VIOLATION       	 	0x1       
