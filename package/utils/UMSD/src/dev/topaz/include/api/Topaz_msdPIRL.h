...
#ifndef __Topaz_msdPIRL_h
#define __Topaz_msdPIRL_h
...
/*
 *  typedef: enum TOPAZ_MSD_PIRL_COUNT_MODE
 *
...
typedef enum
{
    TOPAZ_MSD_PIRL_COUNT_FRAME = 0,
    TOPAZ_MSD_PIRL_COUNT_ALL_LAYER1,
    TOPAZ_MSD_PIRL_COUNT_ALL_LAYER2,
    TOPAZ_MSD_PIRL_COUNT_ALL_LAYER3
} TOPAZ_MSD_PIRL_COUNT_MODE;

/*
 *  typedef: struct TOPAZ_MSD_PIRL_CUSTOM_RATE_LIMIT
 *
 ...
 *      				    TOPAZ_MSD_PIRL2_COUNT_FRAME,
 *                 		    TOPAZ_MSD_PIRL2_COUNT_ALL_LAYER1,
 *          			    TOPAZ_MSD_PIRL2_COUNT_ALL_LAYER2, or
 *            			    TOPAZ_MSD_PIRL2_COUNT_ALL_LAYER3
*/
typedef struct
{
    MSD_BOOL       isValid;
    ...
    /*Count Mode*/
    TOPAZ_MSD_PIRL_COUNT_MODE       countMode;

} TOPAZ_MSD_PIRL_CUSTOM_RATE_LIMIT;

/*
 *  typedef: enum TOPAZ_MSD_PIRL_FC_DEASSERT
 *
 *  Description: Enumeration of the port flow control de-assertion mode on PIRL.
 *
 *  Enumerations:
 *      TOPAZ_MSD_PIRL_FC_DEASSERT_EMPTY -
 *                De-assert when the ingress rate resource has become empty
 *        TOPAZ_MSD_PIRL_FC_DEASSERT_CBS_LIMIT -
 *                De-assert when the ingress rate resource has enough room as
 *                specified by the CBSLimit.
 */
typedef enum
{
    TOPAZ_MSD_PIRL_FC_DEASSERT_EMPTY = 0,
    TOPAZ_MSD_PIRL_FC_DEASSERT_CBS_LIMIT
} TOPAZ_MSD_PIRL_FC_DEASSERT;

/*
 * Typedef: enum TOPAZ_MSD_PIRL_ACTION
 *
 ...
 *
 * Fields:
 *        Topaz_PIRL_ACTION_ACCEPT - accept the frame
 *        Topaz_PIRL_ACTION_USE_LIMIT_ACTION - use EBS Limit Action
 */
typedef enum
{
    Topaz_PIRL_ACTION_USE_LIMIT_ACTION = 0x0,
    Topaz_PIRL_ACTION_ACCEPT     = 0x1
} TOPAZ_MSD_PIRL_ACTION;


/*
 * Typedef: enum TOPAZ_MSD_EBS_LIMIT_ACTION
 *
 ...
 *
 * Fields:
 *        Topaz_EBS_LIMIT_ACTION_DROP - drop packets
 *        Topaz_EBS_LIMIT_ACTION_FC   - send flow control packet
 */
typedef enum
{
    Topaz_EBS_LIMIT_ACTION_DROP     = 0x0,
    Topaz_EBS_LIMIT_ACTION_FC       = 0x1
} TOPAZ_MSD_EBS_LIMIT_ACTION;

/*
 *  typedef: struct TOPAZ_MSD_PIRL_DATA
 *
 ...
 *                                Topaz_PIRL_ACTION_ACCEPT - accept the frame
 *                                Topaz_PIRL_ACTION_USE_LIMIT_ACTION - use limitAction
...
typedef struct
{
	...
	/*flow control*/
    TOPAZ_MSD_PIRL_FC_DEASSERT		fcMode;
    TOPAZ_MSD_PIRL_ACTION    actionMode;
    TOPAZ_MSD_EBS_LIMIT_ACTION ebsLimitAction;
