...
{
	return Topaz_gvlnSetPortVlanDot1qMode(dev, port, (TOPAZ_MSD_8021Q_MODE)mode);
}
/*******************************************************************************
...
{
	return Topaz_gvlnGetPortVlanDot1qMode(dev, port, (TOPAZ_MSD_8021Q_MODE*)mode);
}
/*******************************************************************************
...
{
	return Topaz_gprtSetDiscardTagged(dev, port, mode);
}
/*******************************************************************************
...
{
	return Topaz_gprtGetDiscardTagged(dev, port, mode);
}
/*******************************************************************************
...
{
	return Topaz_gprtSetDiscardUntagged(dev, port, mode);
}
/*******************************************************************************
...
{
	return Topaz_gprtGetDiscardUntagged(dev, port, mode);
}
/*******************************************************************************
...
{
	return Topaz_gprtSetUnicastFloodBlock(dev, port, mode);
}
/*******************************************************************************
...
{
	return Topaz_gprtGetUnicastFloodBlock(dev, port, mode);
}
/*******************************************************************************
...
{
	return Topaz_gprtSetMulticastFloodBlock(dev, port, mode);
}
...
{
	return Topaz_gprtGetMulticastFloodBlock(dev, port, mode);
}
...
{
	return Topaz_gprtSetDiscardBCastMode(dev, port, en);
}
...
{
	return Topaz_gprtGetDiscardBCastMode(dev, port, en);
}
...
{
	return Topaz_gprtSetJumboMode(dev, port, (TOPAZ_MSD_MTU_SIZE)mode);
}
...
{
	return Topaz_gprtGetJumboMode(dev, port, (TOPAZ_MSD_MTU_SIZE*)mode);
}
...
{
	return Topaz_gprtSetLearnEnable(dev, port, mode);
}
...
{
	return Topaz_gprtGetLearnEnable(dev, port, mode);
}
...
{
    return Topaz_gprtGetVTUPriorityOverride(dev, port, (TOPAZ_MSD_PRI_OVERRIDE*)mode);
}
...
{
    return Topaz_gprtSetVTUPriorityOverride(dev, port, (TOPAZ_MSD_PRI_OVERRIDE)mode);
}
...
{
    return Topaz_gprtGetSAPriorityOverride(dev, port, (TOPAZ_MSD_PRI_OVERRIDE*)mode);
}
...
{
    return Topaz_gprtSetSAPriorityOverride(dev, port, (TOPAZ_MSD_PRI_OVERRIDE)mode);
}
...
{
    return Topaz_gprtGetDAPriorityOverride(dev, port, (TOPAZ_MSD_PRI_OVERRIDE*)mode);
}
...
{
    return Topaz_gprtSetDAPriorityOverride(dev, port, (TOPAZ_MSD_PRI_OVERRIDE)mode);
}
...
{
	TOPAZ_MSD_PORT_FC_MODE topazMode;
	switch (mode)
	{
	case MSD_PORT_FC_TX_RX_ENABLED:
		topazMode = Topaz_PORT_FC_TX_RX_ENABLED;
		break;
	...
	return Topaz_gprtSetFlowCtrl(dev, port, en, topazMode);
}
/*******************************************************************************
...
{
	return Topaz_gprtGetFlowCtrl(dev, port, en, (TOPAZ_MSD_PORT_FC_MODE*)mode);
}
...
{
	TOPAZ_MSD_PORT_FORCED_SPEED_MODE topazMode;
	switch (mode)
	{
	case MSD_PORT_FORCE_SPEED_10M:
		topazMode = Topaz_PORT_FORCE_SPEED_10M;
		break;
	case MSD_PORT_FORCE_SPEED_100M:
		topazMode = Topaz_PORT_FORCE_SPEED_100M;
		break;
	case MSD_PORT_FORCE_SPEED_200M:
		topazMode = Topaz_PORT_FORCE_SPEED_200M;
		break;
	case MSD_PORT_FORCE_SPEED_1000M:
		topazMode = Topaz_PORT_FORCE_SPEED_1000M;
		break;
	case MSD_PORT_FORCE_SPEED_2_5G:
		topazMode = Topaz_PORT_FORCE_SPEED_2_5G;
		break;
	case MSD_PORT_FORCE_SPEED_10G:
		return MSD_NOT_SUPPORTED;
	case MSD_PORT_DO_NOT_FORCE_SPEED:
		topazMode = Topaz_PORT_DO_NOT_FORCE_SPEED;
		break;
	default:
		MSD_DBG_ERROR(("Failed (Bad Speed).\n"));
		return MSD_BAD_PARAM;
	}
	return Topaz_gprtSetForceSpeed(dev, port, topazMode);
}
...
{
	return Topaz_gprtGetForceSpeed(dev, port, (TOPAZ_MSD_PORT_FORCED_SPEED_MODE*)mode);
}
...
*                                MSD_ELIMIT_LAYER3 (see Topaz_grcSetELimitMode)
...
{
    return Topaz_grcSetEgressRate(dev, port, (TOPAZ_MSD_ELIMIT_MODE)mode, rate);
}
...
{
    return Topaz_grcGetEgressRate(dev, port, (TOPAZ_MSD_ELIMIT_MODE*)mode, rate);
}
...
{
	return Topaz_grcSetELimitMode(dev, port, (TOPAZ_MSD_ELIMIT_MODE)mode);
}
...
{
	return Topaz_grcGetELimitMode(dev, port, (TOPAZ_MSD_ELIMIT_MODE*)mode);
}
...
{
    return Topaz_gprtSetDuplex(dev, port, (TOPAZ_MSD_PORT_FORCE_DUPLEX_MODE)mode);
}
...
{
    return Topaz_gprtGetDuplex(dev, port, (TOPAZ_MSD_PORT_FORCE_DUPLEX_MODE*)mode);
}
...
{
	return Topaz_gprtGetDuplexStatus(dev, port, mode);
}
...
{
    return Topaz_gprtGetForceLink(dev, port, (TOPAZ_MSD_PORT_FORCE_LINK_MODE*)mode);
}
...
{
    return Topaz_gprtSetForceLink(dev, port, (TOPAZ_MSD_PORT_FORCE_LINK_MODE)mode);
}
...
{
	return Topaz_gprtGetSpeed(dev, port, (TOPAZ_MSD_PORT_SPEED*)speed);
}
...
{
    return Topaz_gprtGetFrameMode(dev, port, (TOPAZ_MSD_FRAME_MODE*)mode);
}
...
{
    return Topaz_gprtSetFrameMode(dev, port, (TOPAZ_MSD_FRAME_MODE)mode);
}
...
{
    return Topaz_gprtGetPortState(dev, port, (TOPAZ_MSD_PORT_STP_STATE*)mode);
}
...
{
    return Topaz_gprtSetPortState(dev, port, (TOPAZ_MSD_PORT_STP_STATE)mode);
}
...
{
    return Topaz_gprtSetCutThrouthEnable(dev, port, (TOPAZ_CUT_THROUGH*)cutThru);
}
...
{
    return Topaz_gprtGetCutThrouthEnable(dev, port, (TOPAZ_CUT_THROUGH*)cutThru);
}