...
/*******************************************************************************************
  ...
  Description  : This function returns a 16-bit value corresponding to the product ID given
                 a device's handle.
  Parameters   :
                 cyusb_handle *handle : Pointer to a struct of type cyusb_handle.
...
/*******************************************************************************************
  Prototype    : unsigned short cyusb_getdevice(cyusb_handle *);
  ...
  Return Value : Returns the 16-bit device ID of the given device.
 *******************************************************************************************/
extern unsigned short cyusb_getdevice(cyusb_handle *);
