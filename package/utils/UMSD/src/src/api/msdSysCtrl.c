...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysSetFloodBC != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysSetFloodBC(dev, en);
	else
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGetFloodBC != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysGetFloodBC(dev, en);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysSetMonitorMgmtCtrl != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysSetMonitorMgmtCtrl(dev, point, data);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGetMonitorMgmtCtrl != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysGetMonitorMgmtCtrl(dev, point, data);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysSetCPUDest != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysSetCPUDest(dev, portNum);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGetCPUDest != NULL)
        return dev->SwitchDevObj.SYSCTRLObj.gsysGetCPUDest(dev, portNum);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysSetIngressMonitorDest != NULL)
        return dev->SwitchDevObj.SYSCTRLObj.gsysSetIngressMonitorDest(dev, portNum);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGetIngressMonitorDest != NULL)
        return dev->SwitchDevObj.SYSCTRLObj.gsysGetIngressMonitorDest(dev, portNum);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysSetEgressMonitorDest != NULL)
        return dev->SwitchDevObj.SYSCTRLObj.gsysSetEgressMonitorDest(dev, portNum);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGetEgressMonitorDest != NULL)
        return dev->SwitchDevObj.SYSCTRLObj.gsysGetEgressMonitorDest(dev, portNum);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysSetRsvd2CpuEnables != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysSetRsvd2CpuEnables(dev, enBits);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGetRsvd2CpuEnables != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysGetRsvd2CpuEnables(dev, enBits);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysSetMGMTPri != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysSetMGMTPri(dev, pri);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGetMGMTPri != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysGetMGMTPri(dev, pri);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGlobal1RegDump != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysGlobal1RegDump(dev);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.SYSCTRLObj.gsysGlobal2RegDump != NULL)
		return dev->SwitchDevObj.SYSCTRLObj.gsysGlobal2RegDump(dev);
	else
		return MSD_NOT_SUPPORTED;
}