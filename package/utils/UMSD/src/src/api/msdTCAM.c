...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamFlushAll != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamFlushAll(dev);
	else
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamFlushEntry != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamFlushEntry(dev, tcamPointer);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamLoadEntry != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamLoadEntry(dev, tcamPointer, tcamData);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamReadTCAMData != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamReadTCAMData(dev, tcamPointer, tcamData);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamGetNextTCAMData != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamGetNextTCAMData(dev, tcamPointer, tcamData);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamFindEntry != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamFindEntry(dev, tcamPointer, tcamData, found);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
    ...
    if (dev->SwitchDevObj.TCAMObj.gtcamSetMode != NULL)
        return dev->SwitchDevObj.TCAMObj.gtcamSetMode(dev, portNum, mode);
    else
        return MSD_NOT_SUPPORTED;
}
...
)
{
    ...
    if (dev->SwitchDevObj.TCAMObj.gtcamGetMode != NULL)
        return dev->SwitchDevObj.TCAMObj.gtcamGetMode(dev, portNum, mode);
    else
        return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
    ...
    if (dev->SwitchDevObj.TCAMObj.gtcamAddEntryPort != NULL)
        return dev->SwitchDevObj.TCAMObj.gtcamAddEntryPort(dev, tcamPointer, portNum);
    else
        return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
    ...
    if (dev->SwitchDevObj.TCAMObj.gtcamRemoveEntryPort != NULL)
        return dev->SwitchDevObj.TCAMObj.gtcamRemoveEntryPort(dev, tcamPointer, portNum);
    else
        return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamEgrFlushEntry != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamEgrFlushEntry(dev, portNum, tcamPointer);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamEgrFlushEntryAllPorts != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamEgrFlushEntryAllPorts(dev, tcamPointer);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamEgrLoadEntry != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamEgrLoadEntry(dev, portNum, tcamPointer, tcamData);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamEgrGetNextTCAMData != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamEgrGetNextTCAMData(dev, portNum, tcamPointer, tcamData);
	else
		return MSD_NOT_SUPPORTED;
}
/*******************************************************************************
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamEgrReadTCAMData != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamEgrReadTCAMData(dev, portNum, tcamPointer, tcamData);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.TCAMObj.gtcamDump != NULL)
		return dev->SwitchDevObj.TCAMObj.gtcamDump(dev);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
    ...
    if (dev->SwitchDevObj.TCAMObj.gtcamAdvConfig != NULL)
        return dev->SwitchDevObj.TCAMObj.gtcamAdvConfig(dev, pktType, tcamPointer, tcamPointer2, keyMaskPtr, keyPtr, maskPtr,patternPtr, actionPtr, entry2Used);
    else
        return MSD_NOT_SUPPORTED;
}
