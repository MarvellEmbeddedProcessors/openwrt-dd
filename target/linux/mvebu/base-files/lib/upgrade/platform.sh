...
platform_do_upgrade() {
	...
	armada-385-linksys-caiman|armada-385-linksys-cobra|armada-385-linksys-rango|armada-385-linksys-shelby|armada-385-linksys-venom|armada-xp-linksys-mamba)
		...
		;;
	armada-385-turris-omnia|armada-388-clearfog-base|armada-388-clearfog-pro|marvell,armada8040-mcbin)
		platform_do_upgrade_sdcard "$ARGV"
		;;
	globalscale,espressobin)
		platform_do_upgrade_espressobin "$ARGV"
		;;
	*)
...
platform_copy_config() {
	...
	armada-385-turris-omnia|armada-388-clearfog-base|armada-388-clearfog-pro|marvell,armada8040-mcbin)
		...
		;;
	globalscale,espressobin)
		platform_copy_config_espressobin "$ARGV"
		;;
	esac
}
